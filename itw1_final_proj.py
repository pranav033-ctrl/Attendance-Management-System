#   Pranav  Patil    BT19CSE099
#   Diwyani Kemekar  BT19CSE077
#   Harsh   Ramteke  BT19CSE072
#   Ekta    Singh    BT19CSE095
    ...
    while(1):
        ...
        if(switch_key == 1):
            ...
            for course in total_course:
                print(course)
            temp = int(input())
            #func call for calculation
            eligibility_for_exam(total_course[temp])
        else:
